...
import com.xz.oa.core.service.meeting.MeetingUserService;

@Controller
@RequestMapping(value = "/meetinguser")
public class MeetingUserController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<MeetingUser> pageInfo = meetingUserService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(MeetingUser entity) {
		return meetingUserService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		MeetingUser entity = meetingUserService.findById(id);
	...
	public @ResponseBody
	JsonResult update(MeetingUser entity) {
		return meetingUserService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return meetingUserService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return meetingUserService.removeByIds(ids);
	}
