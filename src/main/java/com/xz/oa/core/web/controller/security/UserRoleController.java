...
import com.xz.oa.core.service.security.UserRoleService;

@Controller
@RequestMapping(value = "/userrole")
public class UserRoleController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<UserRole> pageInfo = userRoleService.queryPageList(entity, pageIndex, ConfigValue.PAGE_SIZE);
	...
	public @ResponseBody
	JsonResult add(UserRole entity) {
	...
	public @ResponseBody
	JsonResult update(UserRole entity) {
		return userRoleService.modify(entity);
	}
