...
@Controller
@RequestMapping(value = "/rpfile")
public class RpFileController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<RpFile> pageInfo = rpFileService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(RpFile entity) {
		return rpFileService.create(entity);
	}
	...
	public @ResponseBody
	JsonResult update(RpFile entity) {
		return rpFileService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return rpFileService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return rpFileService.removeByIds(ids);
	}
