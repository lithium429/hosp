...
import com.xz.oa.core.service.book.BookVerifyRecordService;

@Controller
@RequestMapping(value = "/bookverifyrecord")
public class BookVerifyRecordController extends SpringBaseController {

	@Resource
	private BookVerifyRecordService bookVerifyRecordService;
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<BookVerifyRecord> pageInfo = bookVerifyRecordService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(BookVerifyRecord entity) {
		return bookVerifyRecordService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		BookVerifyRecord entity = bookVerifyRecordService.findById(id);
	...
	public @ResponseBody
	JsonResult update(BookVerifyRecord entity) {
		return bookVerifyRecordService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return bookVerifyRecordService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return bookVerifyRecordService.removeByIds(ids);
	}
