...
<gd:PopLayout>
	...
	<div class="data_model data_cont_wrap pop_wrap">
		<form id="data_form" method="post" action="bookBorrow/change.do" data-ajax="true" data-ajax-begin="showTip" data-ajax-complete="hideTip" data-ajax-success="backToList" data-ajax-error="showError">
...
var opener = art.dialog.open.origin;
	$(function(){
		...
		$("#ids1").val(opener.$("#HiddenIds1").val());
		
		
	});
	function backToList(result) {
		if (result.flag) {
			successMsg('审核成功！', function() {
				opener.$("#HiddenIds,#HiddenIds1").val('');
