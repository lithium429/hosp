...
<gd:PopLayout>
	<jsp:body> 
	<gd:Navgation addShow="${gdf:judgeRoleMenu(roleMenuList,'添加') }" addlink="bookType/add.do" addr="图书管理  &gt; 图书类型"></gd:Navgation>
	<div class="data_model">
	    <table class="wc100">
	        <tr>
	             <td>
					<div class="data_cont_wrap">
						<form id="spec_form" action="bookType/datalist.do"
										...
										<tr>
											...
											<td>
												<span class="btn btn_pub">
													...
													<a href="bookType/list.do?menu_id=${menu_id}">重置</a>
												</span>
											</td>
										</tr>
									 </tbody>
