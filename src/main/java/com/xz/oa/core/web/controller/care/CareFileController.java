...
@Controller
@RequestMapping(value = "/carefile")
public class CareFileController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<CareFile> pageInfo = careFileService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(CareFile entity) {
		return careFileService.create(entity);
	}
	...
	public @ResponseBody
	JsonResult update(CareFile entity) {
		return careFileService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return careFileService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return careFileService.removeByIds(ids);
	}
