...
<gd:PopLayout>
	...
	<jsp:body>
		...
		<div class="data_model data_cont_wrap pop_wrap">
			<form id="data_form" method="post" action="menu/add.do" data-ajax="true" data-ajax-begin="showTip" data-ajax-complete="hideTip" data-ajax-success="backToList" data-ajax-error="showError">
				...
				<table class="view wc100">
					<tbody>
						<tr>
							<th class="w120"><span class="c_red">*</span>名称：</th>
							<td>
						...
						<tr>
							<th>是否在新窗口打开</th>
							<td>
								<label><input type="radio" value="true" class="is_open_new" name="is_open_new"  />是</label>
								<label><input type="radio" value="false" class="is_open_new ml80" checked="checked" name="is_open_new"  />否</label>
							</td>
						</tr>
					</tbody>
					<tfoot>
