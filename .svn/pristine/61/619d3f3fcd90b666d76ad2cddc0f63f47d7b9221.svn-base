...
package com.xz.oa.core.web.controller.organization; 
...
public class CompanyController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<Company> pageInfo = companyService.queryPageList(entity, pageIndex, ConfigValue.PAGE_SIZE);
	...
	public String update(Integer id, Model model) {
		Company entity = companyService.findById(id);
	...
	public @ResponseBody
	JsonResult update(Company entity) {
		return companyService.modify(entity);
	}
	...
	JsonResult batchDelete(String ids) {
		return companyService.removeByIds(ids);
	}
