...
public class EmailUserController extends SpringBaseController {
	...
	public @ResponseBody
	JsonResult add(EmailUser entity) {
		return emailUserService.create(entity);
	}
	...
	public @ResponseBody
	JsonResult update(EmailUser entity) {
		return emailUserService.modify(entity,0);
	}
	...
	JsonResult batchDelete(String ids) {
		return emailUserService.removeByIds(ids,0);
	}
