...
<gd:PopLayout>
	<jsp:body> 
	<gd:Navgation addShow="${gdf:judgeRoleMenu(roleMenuList,'添加') }" addlink="meetingRoom/add.do" addr="会议管理  &gt; 会议室管理"></gd:Navgation>
	<div class="data_model">
	    <table class="wc100">
	        <tr>
	             <td>
					<div class="data_cont_wrap">
						<form id="spec_form" action="meetingRoom/datalist.do"
										...
										<tr>
											...
											<td>
												<span class="btn btn_pub">
													...
													<a href="meetingRoom/list.do?menu_id=${menu_id}">重置</a>
												</span>
											</td>
										</tr>
									 </tbody>
