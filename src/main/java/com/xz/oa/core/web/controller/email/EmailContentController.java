...
import com.xz.oa.core.service.email.EmailContentService;

@Controller
@RequestMapping(value = "/emailcontent")
public class EmailContentController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<EmailContent> pageInfo = emailContentService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(EmailContent entity) {
		return emailContentService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		EmailContent entity = emailContentService.findById(id);
	...
	public @ResponseBody
	JsonResult update(EmailContent entity) {
		return emailContentService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return emailContentService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return emailContentService.removeByIds(ids);
	}
