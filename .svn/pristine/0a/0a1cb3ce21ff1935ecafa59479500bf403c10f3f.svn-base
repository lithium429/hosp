...
<gd:PopLayout>
	...
	<div class="data_model data_cont_wrap pop_wrap">
		<form id="data_form" method="post" action="meeting/change.do" data-ajax="true" data-ajax-begin="showTip" data-ajax-complete="hideTip" data-ajax-success="backToList" data-ajax-error="showError">
			<input type="hidden" name="id" value="${id}" />
			<input type="hidden" name="ids" id="ids" value="" />
			<input type="hidden" name="is_agree" id="is_agree" value="${is_agree }" />
