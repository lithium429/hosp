...
//
//    @RequestMapping(value = "running_list")
//    public ModelAndView running(Model model, HttpServletRequest request) {
//
//        ModelAndView mav = new ModelAndView("core/workflow/running_list");
//
//        ProcessInstanceQuery processInstanceQuery = runtimeService.createProcessInstanceQuery();
//        List<ProcessInstance> list = processInstanceQuery.listPage(0, Integer.MAX_VALUE);
...
//        }
//        return "redirect:/workflow/processinstance/running_list";
//    }
//}
