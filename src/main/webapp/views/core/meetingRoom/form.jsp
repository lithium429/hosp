...
<table class="view wc100">
	<tbody>
		<tr>
			<th class="w20per"><span class="c_red">*</span>会议室名称：</th>
			<td>
				<input type="text" class="inp_t" data-val="true"
				data-val-required="请输入会议室名称！" id="name" name="name"
				data-val-remote-url="meetingRoom/validateName.do" 
				data-val-remote-type="POST" 
				data-val-remote-additionalfields="*.name,*.id" 
				data-val-remote="该会议室名称已存在！" 
				value="${model.name}" />
		...
		<tr>
			<th class="">地址：</th>
			<td>
				<input type="text" class="inp_t" id="address" name="address" value="${model.address}" />
			</td>
		</tr>
		<tr>
			<th class="vtop">备注:&nbsp;</th>
