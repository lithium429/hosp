...
<gd:Layout>
	...
	<form id="data_form" method="post" action="sms/send.do" data-ajax="true" data-ajax-begin="showTip" data-ajax-complete="hideTip" data-ajax-success="backToList" data-ajax-error="showError">	
