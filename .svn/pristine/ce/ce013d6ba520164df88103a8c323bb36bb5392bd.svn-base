		   ...
		   <input type="hidden" name="id"  value="${model.id}" />
			<table class="view wc100">
				<tbody>
					...
					<tr>
						<td colspan="2" id="showTable" class="shfw_c">
						    ...
						    <thead>
						   	...
						   	<tbody>
					           	<tr >
						            ...
						            <td>
						            	<img id="img4" class="img4" width="59px" height="83px" src="<c:if test="${empty model.image_url}">static/images/emptyImage.jpg</c:if><c:if test="${!empty model.image_url}">${model.image_url}</c:if>">
						            </td>
									</tr>      
						   	</tbody>
						   </table>
