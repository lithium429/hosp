...
<div class="t_c photo_box">
	<h2>封面</h2>
	<div class="pic"><img id="img4" class="img4" width="160px" height="160px" src="<c:if test="${empty model.image_url}">images/emptyImage.jpg</c:if><c:if test="${!empty model.image_url}">${model.image_url}</c:if>"></div> 
