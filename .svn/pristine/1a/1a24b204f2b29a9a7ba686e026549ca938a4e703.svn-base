...
@Controller
@RequestMapping(value = "/smsTpl")
public class SmsTplController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<SmsTpl> pageInfo = smsTplService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(SmsTpl entity) {
		return smsTplService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		SmsTpl entity = smsTplService.findById(id);
	...
	public @ResponseBody
	JsonResult update(SmsTpl entity) {
		return smsTplService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return smsTplService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return smsTplService.removeByIds(ids);
	}
