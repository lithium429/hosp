...
import com.xz.oa.core.service.leave.LeaveVerifyRecordService;

@Controller
@RequestMapping(value = "/leaveverifyrecord")
public class LeaveVerifyRecordController extends SpringBaseController {

	@Resource
	private LeaveVerifyRecordService leaveVerifyRecordService;
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<LeaveVerifyRecord> pageInfo = leaveVerifyRecordService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(LeaveVerifyRecord entity) {
		return leaveVerifyRecordService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		LeaveVerifyRecord entity = leaveVerifyRecordService.findById(id);
	...
	public @ResponseBody
	JsonResult update(LeaveVerifyRecord entity) {
		return leaveVerifyRecordService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return leaveVerifyRecordService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return leaveVerifyRecordService.removeByIds(ids);
	}
