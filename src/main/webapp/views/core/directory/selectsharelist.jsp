	...
	<div class="mb10 crumbs"> 
		<div class="tabs_hd">
			<ul class="clearfix Tab_Panels" id="usersel">
				<li><a href="directory/select.do" class="tab_inner">我的文档</a></li>
				<li class="cur"><a href="javascript:void(0);" class="tab_inner">共享文档</a></li>
			</ul>
		</div>
	</div>
							...
							<tr>
								...
								<td>
									<span class="btn btn_pub">
										...
										<a href="directory/selectshare.do">重置</a>
									</span>
								</td>
							</tr>
						 </tbody>
