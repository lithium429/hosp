...
import com.xz.oa.core.service.announcement.AnnouncementDeptService;

@Controller
@RequestMapping(value = "/announcementdept")
public class AnnouncementDeptController extends SpringBaseController {

	@Resource
	private AnnouncementDeptService announcementDeptService;
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<AnnouncementDept> pageInfo = announcementDeptService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(AnnouncementDept entity) {
		return announcementDeptService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		AnnouncementDept entity = announcementDeptService.findById(id);
	...
	public @ResponseBody
	JsonResult update(AnnouncementDept entity) {
		return announcementDeptService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return announcementDeptService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return announcementDeptService.removeByIds(ids);
	}
