...
import com.xz.oa.core.service.meeting.MeetingVerifyRecordService;

@Controller
@RequestMapping(value = "/meetingverifyrecord")
public class MeetingVerifyRecordController extends SpringBaseController {

	@Resource
	private MeetingVerifyRecordService meetingVerifyRecordService;
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<MeetingVerifyRecord> pageInfo = meetingVerifyRecordService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(MeetingVerifyRecord entity) {
		return meetingVerifyRecordService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		MeetingVerifyRecord entity = meetingVerifyRecordService.findById(id);
	...
	public @ResponseBody
	JsonResult update(MeetingVerifyRecord entity) {
		return meetingVerifyRecordService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return meetingVerifyRecordService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return meetingVerifyRecordService.removeByIds(ids);
	}
