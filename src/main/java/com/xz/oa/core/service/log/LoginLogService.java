package com.xz.oa.core.service.log;
...
public class LoginLogService {
	...
	/**
	 * @Description 获取最新的Log 
	 * @param entity
	 * @return LoginLog     
	 */
	public LoginLog queryLastedLog(LoginLog entity) {
		entity.getMap().put("sort", true);
		PageInfo<LoginLog> pageInfo = loginLogDao.selectEntityPageList(entity, 1, 1);
		if (pageInfo != null && pageInfo.getData() != null && !pageInfo.getData().isEmpty()) {
			entity = pageInfo.getData().get(0);
		}
		return entity;
	}
