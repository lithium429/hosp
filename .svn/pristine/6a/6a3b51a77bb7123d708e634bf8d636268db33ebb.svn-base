...
<table class="view wc100">
	<tbody>
		<tr>
			<th class="w20per"><span class="c_red">*</span>图书类型：</th>
			<td>
				<input type="text" class="inp_t" data-val="true"
				data-val-required="请输入图书类型！" id="name" name="name"
				data-val-remote-url="bookType/validateName.do" 
				data-val-remote-type="POST" 
				data-val-remote-additionalfields="*.name,*.id" 
				data-val-remote="该图书类型已存在！" 
				value="${model.name}" />
