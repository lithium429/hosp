...
@Controller
@RequestMapping(value = "/adviceConfig")
public class AdviceConfigController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<AdviceConfig> pageInfo = adviceConfigService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(AdviceConfig entity) {
		return adviceConfigService.create(entity);
	}
	...
	public String set(HttpServletRequest request,Model model) {
		AdviceConfig a=new AdviceConfig();
		AdviceConfig b=adviceConfigService.find(a);
	...
	public @ResponseBody
	JsonResult set(AdviceConfig entity) {
		return adviceConfigService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		AdviceConfig entity = adviceConfigService.findById(id);
	...
	public @ResponseBody
	JsonResult update(AdviceConfig entity) {
		return adviceConfigService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return adviceConfigService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return adviceConfigService.removeByIds(ids);
	}
