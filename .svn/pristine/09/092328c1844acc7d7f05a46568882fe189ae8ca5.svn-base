...
<table class="view wc100">
	<tbody>
		<tr>
			<th class="w20per"><span class="c_red">*</span>奖惩名目：</th>
			<td>
				<input type="text" class="inp_t" data-val="true"
				data-val-required="请输入奖惩名目！" id="name" name="name"
				data-val-remote-url="rpItem/validateName.do" 
				data-val-remote-type="POST" 
				data-val-remote-additionalfields="*.name,*.id" 
				data-val-remote="该奖惩名目已存在！" 
				value="${model.name}" />
