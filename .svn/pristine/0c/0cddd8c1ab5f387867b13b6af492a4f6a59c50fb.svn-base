...
public class MeetingFileController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<MeetingFile> pageInfo = meetingFileService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(MeetingFile entity) {
		return meetingFileService.create(entity);
	}
	...
	public @ResponseBody
	JsonResult update(MeetingFile entity) {
		return meetingFileService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return meetingFileService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return meetingFileService.removeByIds(ids);
	}
