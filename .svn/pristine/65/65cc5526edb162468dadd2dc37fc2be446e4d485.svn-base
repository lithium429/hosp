...
public class PublicityColumnFile extends BaseEntity implements Serializable {
	 ...
	 * 所属公示栏
	 */
	private java.lang.Integer pc_id;
	...
	public PublicityColumnFile() {
	}
	
	public PublicityColumnFile(Integer pc_id) {
		this.pc_id = pc_id;
	}
	...
	public void setPc_id(java.lang.Integer pc_id) {
		this.pc_id = pc_id;
	}

	public java.lang.Integer getPc_id() {
		return this.pc_id;
	}
