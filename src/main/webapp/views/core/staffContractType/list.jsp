...
<gd:PopLayout>
	<jsp:body> 
	<gd:Navgation addShow="${gdf:judgeRoleMenu(roleMenuList,'添加') }" addlink="staffContractType/add.do" addr="人力资源  &gt; 人事信息  &gt; 合同类型"></gd:Navgation>
	<div class="data_model">
	    <table class="wc100">
	        <tr>
	             <td>
					<div class="data_cont_wrap">
						<form id="spec_form" action="staffContractType/datalist.do"
										...
										<tr>
											...
											<td>
												<span class="btn btn_pub">
													...
													<a href="staffContractType/list.do?menu_id=${menu_id}">重置</a>
												</span>
											</td>
										</tr>
									 </tbody>
