...
@Controller
@RequestMapping(value = "/addressGroup")
public class AddressGroupController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<AddressGroup> pageInfo = addressGroupService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(AddressGroup entity) {
		return addressGroupService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		AddressGroup entity = addressGroupService.findById(id);
	...
	public @ResponseBody
	JsonResult update(AddressGroup entity) {
		return addressGroupService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return addressGroupService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return addressGroupService.removeByIds(ids);
	}
