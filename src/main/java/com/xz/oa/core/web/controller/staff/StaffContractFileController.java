...
@Controller
@RequestMapping(value = "/staffcontractfile")
public class StaffContractFileController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<StaffContractFile> pageInfo = staffContractFileService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(StaffContractFile entity) {
	...
	public @ResponseBody
	JsonResult update(StaffContractFile entity) {
