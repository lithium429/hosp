...
<gd:PopLayout>
	...
	<div class="data_model data_cont_wrap pop_wrap">
		<form id="data_form" method="post" action="userlog/add.do" data-ajax="true" data-ajax-begin="showTip" data-ajax-complete="hideTip" data-ajax-success="backToList" data-ajax-error="showError">
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<span class="field-validation-error" data-valmsg-for="user_id" data-valmsg-replace="true"></span>
						</td>
					</tr>
					<tr>
						<th class="w15per"><span class="c_red">*</span>内容:&nbsp;</th>
						<td>
							<input type="text" class="inp_t" data-val="true" data-val-required="请输入内容！" id="content" name="content" value="" />
