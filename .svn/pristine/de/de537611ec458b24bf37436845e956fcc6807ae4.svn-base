...
public class Menu extends BaseEntity implements Serializable {
	 ...
	 * 是否在新窗口打开
	 */
	private java.lang.Boolean is_open_new;
	...
	public java.lang.Boolean getIs_open_new() {
		return is_open_new;
	}

	public void setIs_open_new(java.lang.Boolean is_open_new) {
		this.is_open_new = is_open_new;
	}
