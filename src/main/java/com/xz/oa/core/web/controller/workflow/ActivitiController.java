...
//import com.xz.base.utils.WorkflowUtils;
//import com.xz.oa.core.service.activiti.JumpActivityCmd;
//import com.xz.oa.core.service.activiti.WorkflowProcessDefinitionService;
//import com.xz.oa.core.service.activiti.WorkflowTraceService;
//
///**
// * 流程管理控制器
// *
...
//public class ActivitiController extends SpringBaseController {
//
...
//		List<ProcessDefinition> processDefinitionList = processDefinitionQuery.listPage(0, Integer.MAX_VALUE);
...
//	}
//
//	@RequestMapping(value = "/process/convert_to_model/{processDefinitionId}")
...
//
//		// 已经签收的任务
//		List<Task> todoList = taskService.createTaskQuery().taskAssignee(userId.toString()).active().list();
...
//
//		// 等待签收的任务
//		List<Task> toClaimList = taskService.createTaskQuery().taskCandidateUser(userId.toString()).active().list();
