...
import com.xz.oa.core.service.handlingprocess.HandlingProcessRecordService;

@Controller
@RequestMapping(value = "/handlingprocessrecord")
public class HandlingProcessRecordController extends SpringBaseController {

	@Resource
	private HandlingProcessRecordService handlingProcessRecordService;
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<HandlingProcessRecord> pageInfo = handlingProcessRecordService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(HandlingProcessRecord entity) {
		return handlingProcessRecordService.create(entity);
	}
	...
	public String update(Integer id, Model model) {
		HandlingProcessRecord entity = handlingProcessRecordService.findById(id);
	...
	public @ResponseBody
	JsonResult update(HandlingProcessRecord entity) {
		return handlingProcessRecordService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return handlingProcessRecordService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return handlingProcessRecordService.removeByIds(ids);
	}
