...
public class EmailFileController extends SpringBaseController {
	...
	private void getList(HttpServletRequest request, Model model) {
		...
		PageInfo<EmailFile> pageInfo = emailFileService.queryPageList(entity, pageIndex, pageSize);
	...
	public @ResponseBody
	JsonResult add(EmailFile entity) {
		return emailFileService.create(entity);
	}
	...
	public @ResponseBody
	JsonResult update(EmailFile entity) {
		return emailFileService.modify(entity);
	}
	...
	public JsonResult delete(Integer id) {
		return emailFileService.removeById(id);
	}
	...
	JsonResult batchDelete(String ids) {
		return emailFileService.removeByIds(ids);
	}
