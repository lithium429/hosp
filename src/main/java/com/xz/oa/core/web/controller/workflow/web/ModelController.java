...
import com.xz.oa.core.service.activiti.service.ActivitiService;
...
//            daoCtl.exeUpdateBySql(dao,sql);
	...
	public String toadd(@RequestParam(value = "categoryId",required = false) String categoryId, HttpServletRequest req) {
//        req.setAttribute("categoryId", categoryId);
//        List<Wf_model_category> list = dao.findCategorywf();
//        req.setAttribute("list", list);
        System.out.println("gotoaddmodel");
        return "core/workflow/add";
    }
	
	@RequestMapping(value="/addModel")
	@ResponseBody
	public JsonResult addModel(@RequestParam(value = "categoryId",required = false) String categoryId, @RequestParam("name") String name, @RequestParam("key") String key, @RequestParam(value = "description",required = false) String description, HttpServletRequest req) throws UnsupportedEncodingException {
//        Map<String, Object> map = new HashMap<String, Object>();
...
//        map.put("errmsg", "");
	...
	public String deploy(@PathVariable("modelId") String modelId,RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "部署失败，部署ID=" + modelId);
        }
...
//            map.put("errmsg", "删除模型失败：modelId=" + modelId + "\r\n" + e.getMessage());
    ...
    public ModelAndView list(@RequestParam(value = "categoryId",required = false) String categoryId,  @RequestParam(value = "keyword",required = false) String keyword) {
        //@RequestParam(value = "page",required = false) int curPage, @RequestParam(value = "rows",required = false) int pageSize,
        ...
        list = modelQuery2.orderByCreateTime().desc().list();//.listPage((curPage - 1) * pageSize, pageSize)
