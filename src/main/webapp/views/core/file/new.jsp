	...
	<jsp:body>
		...
		<div class="data_model data_cont_wrap pop_wrap">
			<form id="form0" action="${baseUrl}/file/upload.do" enctype="multipart/form-data"> 
				...
				<input type="hidden" id="module_type" name="module_type" value="${moduleType}" />
				<input type="hidden" id="directory_id" name="directory_id" value="${directoryId}" />
